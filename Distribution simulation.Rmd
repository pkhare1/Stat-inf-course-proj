...
#### Code for computing sample mean and plotting the sample and theoretical distributions
```{r, echo=TRUE}
...
#### Code for computing sample and theoretical variance
```{r, echo=TRUE}
...
#### Code for plotting exponential function with n=1000
```{r, echo=TRUE}
hist(rexp(1000, 0.2)) #histogram of exponential function with n=1000 and lambda=0.2
```

#### Code for plotting the distribution of means of 1000 exponential functions and overlaying with theoretical normal distribution
```{r, echo=TRUE}
mns = NULL
